...
function Modal({ isOpen }: { isOpen: { data: boolean } }) {
    ...
    return (
        <div>
            ...
            <div className='fixed z-20 bg-white top-[15%] left-[50%] translate-x-[-50%]  max-w-[600px] mx-auto p-[30px] rounded-2xl '>
                <p className='mb-[30px]'>
                ...
                <div className='flex justify-center'>
                    <button
                        ...
                        className=' cursor-pointer bg-[#1BB394] text-white py-[10px] px-[25px] rounded-xl'>
                        Согласен
                    </button>
                </div>
            </div>
